  ...
  return (
    <>
      ...
      <img
        ...
        src="/icons/menu.svg"
        alt=""
        className="md:hidden px-2 cursor-pointer"
      />
      <div className="text-white hidden md:flex items-center font-bold text-sm gap-x-3 lg:gap-x-8 xl:gap-x-12">
        <h3
          onClick={() => {
            if (!isHome) r.push("/#home");
            else scrollKe("home");
        ...
        <h3
          ...
          className="flex items-center cursor-pointer border border-sky-light rounded-[48px] md:px-6 xl:px-8 py-2"
        >
          Job Fair
        </h3>
        <ProfileButton />
